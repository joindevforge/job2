      ...
      <div className="wrapper bg-[#DBEFFE] mt-[12.19rem]">
        <div className="wrapper-item py-[100px]">
          <div className="w-full h-full flex flex-col items-center">
            <h1 className="lg:w-[45%] md:w-[65%] w-[95%] h-full md:text-[2rem] text-[1.75rem] font-[700] text-center font-domine">
              Helping teens get ahead whether it is college or career
            </h1>
            <p className="md:mt-[40px] mt-[20px] lg:w-[57%] md:w-[75%] w-[90%] md:text-center text-left font-Inter text-[1.25rem] font-[400]">
