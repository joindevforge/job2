    ...
    <>
      <div className="h-[75vh]  w-full max-w-[1280px] mx-auto  flex items-center justify-center">
        <div className="  flex flex-col  items-center">
          ...
          <p className=" sm:mt-[46px] mt-[30px] text-[#595959] w-full px-[30px] sm:w-[53%] font-Inter font-[400] leading-[1.75] tracking-[-0.015em] text-[18px] sm:text-[20px]">
      ...
      <div className=" bg-[#F4F4F4] py-[50px]  sm:py-[100px]">
        <div className=" max-w-[1280px] mx-auto">
          ...
          <div className="mt-[50px]  px-[30px] sm:px-0 flex flex-col items-center">
            ...
            <div className=" text-[#595959] sm:mt-[50px] mt-[20px] font-Inter text-[18px] sm:w-[56%] w-full font-[400] leading-[1.75] tracking-[-0.015em]">
      ...
      <div className=" sm:py-[100px] py-[50px] max-w-[1280px] w-full mx-auto px-[30px] sm:px-[145px]">
        ...
        <div className="sm:mt-[175px]  mt-[60px] mx-auto max-w-[1280px]">
